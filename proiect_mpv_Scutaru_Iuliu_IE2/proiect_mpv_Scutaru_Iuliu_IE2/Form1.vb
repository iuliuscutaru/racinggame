Public Class Form1
    ...
    Private Sub Enemy1_Mover_Tick(sender As Object, e As EventArgs) Handles Enemy1_Mover.Tick
        ...
        If EnemyCar1.Top >= Me.Height Then
            ...
            EnemyCar1.Top = -(CInt(Math.Ceiling(Rnd() * 278)) + EnemyCar1.Height)
            EnemyCar1.Left = CInt(Math.Ceiling(Rnd() * 120)) + 0
        End If
    End Sub
    ...
    Private Sub Enemy2_Mover_Tick(sender As Object, e As EventArgs) Handles Enemy2_Mover.Tick
        ...
        If EnemyCar2.Top >= Me.Height Then
            score += 1
            Score_text.Text = "Score " & score
            EnemyCar2.Top = -(CInt(Math.Ceiling(Rnd() * 278)) + EnemyCar2.Height)
            EnemyCar2.Left = CInt(Math.Ceiling(Rnd() * 140)) + 120
        End If
    End Sub
    ...
    Private Sub Enemy3_Mover_Tick(sender As Object, e As EventArgs) Handles Enemy3_Mover.Tick
        ...
        If EnemyCar3.Top >= Me.Height Then
            score += 1
            Score_text.Text = "Score " & score
            EnemyCar3.Top = -(CInt(Math.Ceiling(Rnd() * 278)) + EnemyCar3.Height)
            EnemyCar3.Left = CInt(Math.Ceiling(Rnd() * 100)) + 300
        End If
    End Sub
